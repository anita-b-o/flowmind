  ...
  return <main className="content stack">
    <header className="page-header">
      <div>
        ...
        <p className="muted">See what is moving, what needs attention and where to build next.</p>
      </div>
      <div className="brand-actions"><Link href="/workflows">Open workflows</Link><Link className="secondary" href="/templates">Explore templates</Link></div>
    </header>
    <div className="grid">
